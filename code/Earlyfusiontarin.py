...
def cross_validation(feature_matrix, label_matrix, clf_type, event_num, seed, CV, set_name):
    ...
    for k in range(0,5):
        ...
        dnn.save('smile+target+enzyme+pingjie_3layer_model_weight_{}.h5'.format(k))
...
def main(args):
    ...
    #     # =============================================================================
         #save_result(featureName, 'all_pingjei', clf, all_result)
         #save_result(featureName, 'each_pingjei', clf, each_result)
